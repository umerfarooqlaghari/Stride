...
const modules = [
  {
    ...
    kpis: [
      ...
      { label: "Berths Available", value: "2" },
      { label: "Pending MT", value: "12,400" },
    ],
  },
  {
    tag: "B",
    ...
    kpis: [
      ...
      { label: "Processed Today", value: "214" },
      { label: "Match Rate", value: "96.2%" },
    ],
  },
  {
    tag: "C",
    ...
    kpis: [
      { label: "Cranes Active", value: "6/8" },
      { label: "Trucks En Route", value: "23" },
  ...
  },
  {
    ...
    href: "/modules/epod",
    kpis: [
      { label: "Open Trips", value: "51" },
      { label: "Delivered Today", value: "89" },
  ...
  },
  {
    ...
    kpis: [
      { label: "Open Orders", value: "127" },
      { label: "Auto-Invoiced", value: "43" },
      { label: "SLA Met", value: "98.1%" },
    ],
  },
];
    ...
    <div className="flex-1 bg-slate-50">
      ...
      <div className="max-w-screen-xl mx-auto px-6 py-8">
        ...
        <p className="mt-10 text-center text-xs text-slate-400">
          PARCO Downstream Digitization · Supply Chain Hub · Platform v1.0
        </p>
      </div>
    </div>
  );
